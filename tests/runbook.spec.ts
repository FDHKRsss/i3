...
// runbook now documents the real photo/GPS/description flow over BYTEA, and
// the HTTPS reverse-proxy requirement for mobile camera/GPS.
...
describe("runbook (docs) vs. implementation", () => {
  ...
  it("documents the HTTPS requirement for real mobile camera/GPS", () => {
...
describe("runbook compose wiring (docker-compose.yml)", () => {
  ...
  it("publishes APP_PORT -> 8080, waits for the db healthcheck, and drops UPLOAD_DIR", () => {
